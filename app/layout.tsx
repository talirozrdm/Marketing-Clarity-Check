...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "מה באמת תוקע את השיווק שלך עכשיו?", images: ["/og.png"] },
};
